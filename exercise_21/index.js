...
// На каждый вызов функции создается Execution Context - контекст вызова функции (не this).
...
// CallStack = N * 12557 (при вызове функции без параметров, N - это размер Execution Context)
// CallStack = (N + 5 * SizeOfVar) * 8371 (при вызове функции c 5 числовыми параметрами, N - это размер Execution Context)
